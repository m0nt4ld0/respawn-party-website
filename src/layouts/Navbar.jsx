      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/ps-5">PlayStation 5</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/projector-1080p">Proyector 1080p</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/multigame">Sistema multijuegos</Link>
            </li>
            <li className="nav-item">
